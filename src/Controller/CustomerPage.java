 ...
 * Class implements Initializable interface.
 */
public class CustomerPage implements Initializable {
     ...
     *      Lambda usage is ideal as this custom JavaFX method is only used in one function and is only used in this page.
     *      Lambda method acts as a table listener to PopulateForm when row is selected and depopulates form upon deselection (using reset button).
    ...
    /**
     * Method initializes valid data for the country combo box. It adds all countries from database for selection.
     */
    ...
    /**
     * Method runs after country is chosen; it populates division combo box with valid divisions for that country.
     ...
     * @param DivisionID Integer division ID of chosen customer
     * @return Returns String division name to fill combo box
     */
    ...
    /**
     * This method gets country name from customer's division ID to ensure valid data in division combo box.
     * @param DivisionID Division ID from which to get country name
    ...
    /**
     * This method adds or updates customers in the database and on the table view.
     * @param event ActionEvent that is triggered when add/update button is clicked
     * Ensures fields are valid and shows pop-up boxes if not.
     */
    @FXML
    ...
    /**
     * This method gets division ID from division name chosen (for adding/updating a customer).
     * @param DivisionName String division name chosen from combo box
     * @return Integer division ID to add or update customer in database
     */
    ...
    /**
     * This method deletes a customer from the database and in the table view.
     * Customer will not be deleted if they have any scheduled appointments.
     * @param event ActionEvent is triggered when delete button is clicked
     */
    @FXML
    ...
    /**
     * This method checks if customer has appointments before deleting them.
     * @param CustomerID Integer customer ID with which to check appointments table
     * @return Integer number of appointments for customer
     */
    ...
    /**
     * This method clears all fields in the form and deselects row in the table view.
     * @param event ActionEvent is triggered when Reset/Clear button is clicked
     * @throws RuntimeException if null values cannot be added
     */
    @FXML
